    ...
    <button className={styles.likeButton} onClick={() => setIsLiked(!isLiked)}>
      ...
      >
        <g fill="currentColor">
          ...
          <path d="m24 42.7-2.9-2.64C10.8 30.72 4 24.56 4 17 4 10.84 8.84 6 15 6c3.48 0 6.82 1.62 9 4.18C26.18 7.62 29.52 6 33 6c6.16 0 11 4.84 11 11 0 7.56-6.8 13.72-17.1 23.08z" />
        </g>
      </svg>
    </button>
  );
